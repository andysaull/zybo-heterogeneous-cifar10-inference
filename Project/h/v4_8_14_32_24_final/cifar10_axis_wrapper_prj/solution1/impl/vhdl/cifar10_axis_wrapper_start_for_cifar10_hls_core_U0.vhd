...
entity cifar10_axis_wrapper_start_for_cifar10_hls_core_U0 is 
    generic (
...
architecture rtl of cifar10_axis_wrapper_start_for_cifar10_hls_core_U0 is
...
------------------------Component----------------------
    component cifar10_axis_wrapper_start_for_cifar10_hls_core_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_cifar10_axis_wrapper_start_for_cifar10_hls_core_U0_ShiftReg : cifar10_axis_wrapper_start_for_cifar10_hls_core_U0_ShiftReg
    generic map (
...
entity cifar10_axis_wrapper_start_for_cifar10_hls_core_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end cifar10_axis_wrapper_start_for_cifar10_hls_core_U0_ShiftReg;

architecture rtl of cifar10_axis_wrapper_start_for_cifar10_hls_core_U0_ShiftReg is
