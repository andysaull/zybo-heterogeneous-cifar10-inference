...
entity cifar10_axis_wrapper_fifo_w120_d2_S is 
    generic (
...
architecture rtl of cifar10_axis_wrapper_fifo_w120_d2_S is
...
------------------------Component----------------------
    component cifar10_axis_wrapper_fifo_w120_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 120;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_cifar10_axis_wrapper_fifo_w120_d2_S_ShiftReg : cifar10_axis_wrapper_fifo_w120_d2_S_ShiftReg
    generic map (
...
entity cifar10_axis_wrapper_fifo_w120_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 120;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end cifar10_axis_wrapper_fifo_w120_d2_S_ShiftReg;

architecture rtl of cifar10_axis_wrapper_fifo_w120_d2_S_ShiftReg is
