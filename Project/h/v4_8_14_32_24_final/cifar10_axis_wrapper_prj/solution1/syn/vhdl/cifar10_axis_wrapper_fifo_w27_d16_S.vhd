...
entity cifar10_axis_wrapper_fifo_w27_d16_S is 
    generic (
...
architecture rtl of cifar10_axis_wrapper_fifo_w27_d16_S is
...
------------------------Component----------------------
    component cifar10_axis_wrapper_fifo_w27_d16_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 27;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 16);
...
begin
----------------------- Instantiation -----------------------
    U_cifar10_axis_wrapper_fifo_w27_d16_S_ShiftReg : cifar10_axis_wrapper_fifo_w27_d16_S_ShiftReg
    generic map (
...
entity cifar10_axis_wrapper_fifo_w27_d16_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 27;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 16);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end cifar10_axis_wrapper_fifo_w27_d16_S_ShiftReg;

architecture rtl of cifar10_axis_wrapper_fifo_w27_d16_S_ShiftReg is
