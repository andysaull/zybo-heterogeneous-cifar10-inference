...
struct relu_config3 : nnet::activ_config {
    static const unsigned n_in = 7200;
...
struct config5_mult : nnet::dense_config {
    ...
    static const unsigned reuse_factor = 1008;
    static const unsigned strategy = nnet::resource;
    static const unsigned n_zeros = 0;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
...
struct config5 : nnet::conv2d_config {
    ...
    static const unsigned filt_width = 3;
    static const unsigned kernel_size = filt_height * filt_width;
    static const unsigned n_filt = 14;
    static const unsigned stride_height = 1;
    static const unsigned stride_width = 1;
...
struct relu_config6 : nnet::activ_config {
    static const unsigned n_in = 2366;
    static const unsigned table_size = 1024;
    static const unsigned io_type = nnet::io_stream;
    static const unsigned reuse_factor = 2048;
...
struct config8_mult : nnet::dense_config {
    ...
    static const unsigned reuse_factor = 2016;
    static const unsigned strategy = nnet::resource;
    static const unsigned n_zeros = 0;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    typedef conv3_features_accum_t accum_t;
    typedef conv3_features_bias_t bias_t;
    typedef conv3_features_weight_t weight_t;
    template<class data_T, class res_T, class CONFIG_T>
    using kernel = nnet::DenseResource_rf_gt_nin_rem0<data_T, res_T, CONFIG_T>;
    template<class x_T, class y_T>
    using product = nnet::product::mult<x_T, y_T>;
...
struct relu_config9 : nnet::activ_config {
    ...
    static const unsigned io_type = nnet::io_stream;
    static const unsigned reuse_factor = 2048;
    typedef conv3_features_relu_table_t table_t;
};
...
struct config14_mult : nnet::dense_config {
    ...
    static const unsigned n_zeros = 0;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    typedef conv4_mix_accum_t accum_t;
    typedef conv4_mix_bias_t bias_t;
    typedef conv4_mix_weight_t weight_t;
    template<class data_T, class res_T, class CONFIG_T>
    using kernel = nnet::DenseResource_rf_gt_nin_rem0<data_T, res_T, CONFIG_T>;
    template<class x_T, class y_T>
    using product = nnet::product::mult<x_T, y_T>;
...
struct relu_config11 : nnet::activ_config {
    ...
    static const unsigned io_type = nnet::io_stream;
    static const unsigned reuse_factor = 2048;
    typedef conv4_mix_relu_table_t table_t;
};
...
struct config15_mult : nnet::dense_config {
    ...
    static const unsigned reuse_factor = 240;
    static const unsigned strategy = nnet::resource;
    static const unsigned n_zeros = 0;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    typedef conv5_classes_accum_t accum_t;
    typedef conv5_classes_bias_t bias_t;
    typedef conv5_classes_weight_t weight_t;
    template<class data_T, class res_T, class CONFIG_T>
    using kernel = nnet::DenseResource_rf_gt_nin_rem0<data_T, res_T, CONFIG_T>;
    template<class x_T, class y_T>
    using product = nnet::product::mult<x_T, y_T>;
