...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=5,da_clkrst_cnt=5,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [31:0]matrix_mult_0_out_stream_TDATA;
  wire [3:0]matrix_mult_0_out_stream_TKEEP;
  wire [0:0]matrix_mult_0_out_stream_TLAST;
  wire matrix_mult_0_out_stream_TREADY;
  wire matrix_mult_0_out_stream_TVALID;
  ...
  design_1_axi_dma_0_0 axi_dma_0
       (.axi_resetn(rst_ps7_0_50M_peripheral_aresetn),
        ...
        .s_axis_s2mm_tdata(matrix_mult_0_out_stream_TDATA),
        .s_axis_s2mm_tkeep(matrix_mult_0_out_stream_TKEEP),
        .s_axis_s2mm_tlast(matrix_mult_0_out_stream_TLAST),
        .s_axis_s2mm_tready(matrix_mult_0_out_stream_TREADY),
        .s_axis_s2mm_tvalid(matrix_mult_0_out_stream_TVALID));
  ...
  design_1_matrix_mult_0_0 matrix_mult_0
       (.ap_clk(processing_system7_0_FCLK_CLK0),
        ...
        .out_stream_TDATA(matrix_mult_0_out_stream_TDATA),
        .out_stream_TKEEP(matrix_mult_0_out_stream_TKEEP),
        .out_stream_TLAST(matrix_mult_0_out_stream_TLAST),
        .out_stream_TREADY(matrix_mult_0_out_stream_TREADY),
        .out_stream_TVALID(matrix_mult_0_out_stream_TVALID),
