...
(* CHECK_LICENSE_TYPE = "design_1_matrix_mult_0_0,matrix_mult,{}" *) (* CORE_GENERATION_INFO = "design_1_matrix_mult_0_0,matrix_mult,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=matrix_mult,x_ipVersion=1.0,x_ipCoreRevision=2114562672,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_CTRL_ADDR_WIDTH=4,C_S_AXI_CTRL_DATA_WIDTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
