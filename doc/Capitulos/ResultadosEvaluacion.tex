...
inferencia obtenido en FPGA frente a la ejecución del core C++ generado por hls4ml en el ARM.
...
Legacy. La Zynq-7010 integra una FPGA pequeña para implementar una red convolucional, por lo que el
...
\begin{table}[h!]
  ...
  \begin{tabular}{|l|r|}
    \hline
    \textbf{Recurso} & \textbf{Uso en el diseño final} \\ \hline
    LUT & 16117 \\ \hline
    FF & 17917 \\ \hline
    BRAM & 37,5 \\ \hline
    DSP & 6 \\ \hline
...
integrado en la FPGA. Por el otro, el core C++ generado por hls4ml ejecutado directamente sobre el
...
\end{tabular}
\caption{Benchmark de inferencia CIFAR-10 entre acelerador FPGA y core C++ de hls4ml en ARM}
...
del core C++ de hls4ml en el ARM. Este resultado es coherente con la naturaleza de cada ruta. En la
FPGA, el modelo se convierte en hardware dedicado y puede explotar paralelismo a nivel de
operaciones y de flujo de datos. En cambio, en el ARM se ejecuta una descripción C++ pensada para
...
tipos de dato de precisión fija, estructuras tipo \texttt{hls::stream} y plantillas C++ orientadas a
...
ejecuta una versión C++ del modelo mediante tipos software que emulan precisión fija. Pequeñas
...
sea correcto a nivel de código C++. La versión realmente desplegada es el hardware generado, y por
