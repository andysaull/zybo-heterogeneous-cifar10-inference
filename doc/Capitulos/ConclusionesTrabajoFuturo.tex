...
Zynq-7010. Muchas configuraciones que parecían razonables desde el punto de vista del número de
...
FPGA obtuvo un tiempo medio cercano a 2 ms, frente a unos 171 ms de la ejecución del core C++
...
Vivado, Vitis, Vitis HLS, modelos entrenados, IPs generados y scripts auxiliares, es fácil acabar
...
para aprender y prototipar, pero la Zynq-7010 tiene un margen reducido para implementar CNNs. El
...
la latencia, sino la eficiencia \citep{sze2017efficientprocessingdeepneural}.
