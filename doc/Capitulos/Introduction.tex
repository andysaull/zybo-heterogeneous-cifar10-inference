...
This is where FPGA become a key enabling technology.
Unlike traditional CPU and GPU, which process data either sequentially or through
fixed forms of parallelism, FPGA allow custom hardware architectures to be designed
...
embedded system based on the Zynq Z-7010 SoC, capable of accelerating the inference of a
...
\begin{enumerate}
  ...
  \item \textbf{Acceleration of a baseline computation:} develop a basic linear algebra
    IP core in \texttt{C++}, specifically a matrix multiplication accelerator, and synthesize it
...
multiplication in \texttt{C}/\texttt{C++}. Use of HLS pragmas such as PIPELINE and UNROLL
to optimize
