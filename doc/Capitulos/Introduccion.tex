...
Aquí es donde entran en juego las FPGAs como pieza clave.
A diferencia de las CPUs y GPUs tradicionales que procesan la información de forma
secuencial o en paralelo pero de forma rígida, las FPGAs permiten diseñar arquitecturas
...
actuales como el "Muro de Potencia" (Power Wall), donde seguir subiendo la frecuencia de
...
empotrado heterogéneo basado en el SoC Zynq-7010 capaz de acelerar la inferencia de un
...
\begin{enumerate}
  ...
  \item \textbf{Aceleración de un cálculo base:} Escribir en C++ y sintetizar a hardware
  ...
  \item \textbf{Implementación de IA en recursos limitados:} Adaptar un modelo de red
    ...
    Zynq-7010, generando su hardware equivalente y desarrollando el software de control
...
\textbf{Fase 3.} Desarrollo del Acelerador Base en HLS: Programación en C/C++ de una
